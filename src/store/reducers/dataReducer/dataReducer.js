    ...
    celebrities: [
        {
            ...
            shortBio:'Мастацтвазнавец, мастацкі крытык, фотамастак (1962 - ... )',
        ...
        },
        {
            ...
            photo: Alexeev1,
            shortBio:'Фатограф, выдавец, дызайнер, рэжысёр, журналіст (1978 - ... )',
        ...
        },
        {
            ...
            photo: Anempadystau1,
            shortBio:'Перакладчык, паэт, графічны дызайнер (1964 - 2018)',
        ...
        },
        {
            ...
            photo: Kaltovich1,
            shortBio:'Дызайнер, фатограф (1961 - 2022)',
        ...
        },
        {
            ...
            photo: Likhtarovich1,
            shortBio:'Фотамастак белорусского Полесья (1947 - ... )',
            sliderTxt:'Беларускi плакат',
            text: [
        ...
        },
        {
            ...
            photo: Klinov1,
            shortBio:'Мастак, пісьменнік, архітэктар (1965 - ... )',
